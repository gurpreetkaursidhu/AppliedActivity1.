...
map_modules:
	...
	.byte	0xe, 0x82, 0x0, 0xc7, 0xef, 0xcb, 0x29, 0x41, 0x9d, 0x29, 0xef, 0x33, 0x0, 0x55, 0x7a, 0xcb	// module_uuid: c700820e-cbef-4129-9d29-ef3300557acb
	...
	.byte	0x56, 0xb8, 0xa8, 0x18, 0xfd, 0xfe, 0xe3, 0x46, 0x8f, 0xb0, 0x11, 0x3c, 0x15, 0x18, 0x23, 0xff	// module_uuid: 18a8b856-fefd-46e3-8fb0-113c151823ff
	...
	.byte	0xb9, 0xe7, 0xe0, 0x93, 0xbf, 0xa0, 0x9b, 0x4c, 0x86, 0xd9, 0x62, 0x2, 0xe6, 0xec, 0xc4, 0x4b	// module_uuid: 93e0e7b9-a0bf-4c9b-86d9-6202e6ecc44b
	.word	0x3	// entry_count
	.word	0x0	// duplicate_count
	...
	.byte	0xc1, 0xfa, 0x84, 0x6b, 0x97, 0x19, 0xf5, 0x4c, 0xb5, 0x9b, 0x29, 0x5d, 0x89, 0x6e, 0xfe, 0x94	// module_uuid: 6b84fac1-1997-4cf5-b59b-295d896efe94
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module25_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.25	// assembly_name: AndroidBookAPI
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x2000041	// type_token_id
	.ascii	"crc64228838107cbc056a/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x19	// module_index
	.word	0x2000042	// type_token_id
	.ascii	"crc64228838107cbc056a/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
